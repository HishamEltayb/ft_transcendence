...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/images/new_images/ProfilePage.png} % EditProfile.png not available, using ProfilePage as substitute
    \caption{Edit Profile.} % Interface for updating user information and preferences
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/images/new_images/ProfilePage.png} % OtherProfilePage.png not available, using ProfilePage as substitute
    \caption{Other Player's Profile.} % Viewing another user's profile information and statistics
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/images/new_images/PlayerStatistics.png}
    \caption{Advanced Statistics.} % In-depth analysis of gameplay performance and trends
...
\begin{figure}[H]
    ...
    \caption{Account Settings.} % Management interface for user preferences and account details
...
\subsection{Social Features: Friends and Interactions}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/images/new_images/HomePage.png} % FriendList.png not available, using HomePage as substitute
    \caption{Friend Management.} % Interface for viewing and managing user friendships
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{Figures/images/new_images/MenuBar.png} % ChatInterface.png not available, using MenuBar as substitute
    \caption{Chat System.} % Communication interface for player interaction
